<html>
<head>
<title>Метеонова - выращимаем овощи самостоятельно</title>
...
<div id="bd">
  ...
  <div class="main_container">
			...
			<div class="block_content">
		    	<div class="content">
		        	<div style="position:relative;">
						<h3>Зачем нужен прогноз посадки овощей</h3>
	                	...
	                	<p style="padding-bottom:8px;">Время высадки зависит прежде всего от температур почвы и поверхности земли, а также их прогноза на несколько дней вперед, чтобы можно было избежать возвратов холодов.</p>
						<h3>Как мы считаем</h3>
                    	<p style="padding-bottom:4px;">Для оценки подоходящих условий высадки семян и рассады овощей мы определяем минимальные температуры поверхности почвы, температуры почвы в верхнем слое и температуры почвы в среднем слое на ближайшую неделю. И, если все они оказываются выше порогвых значений для каждой культуры, то такие культуры мы рекомендуем к посадке (напротив названия овоща появляется метка <span style="color:#090"><b>можно</b></span>). Конечно, такой подход это не гарантирует возможных возвратов холодов более чем через неделю, но позволяет дать общую оценку состояния почвы. </p>
						<p style="padding-bottom:4px;">Если земля холоднее, чем нужно менее чем на 2 градуса, пишется статус <span style="color:#cc8000"><b>скоро</b></span>, то есть, скоро почва прогреется до нужного значения, и пора готовиться к посадке.<p>
						<p style="padding-bottom:8px;">Если же почва холоднее положенной для посева семян или высадки рассадки более чем на 2 градуса, то выставляется метка <span style="color:#900"><b>рано</b></span>. Это значит, что условия для посадки пока неблагоприятные.</p>
  	 ...
  	 <div class="right_main">
			<div class="block_top">
   			...
   			<div class="round_right">
				...
				<div class="block_content" style="width:100%;">
					<div class="content" style="width:210px;">
	                    	<p style="padding-bottom:4px;">Выражаем благодарность специалистам Сельскохозяйственной академии им. Тимирязева и Балтийкому федеральноу университету им. И. Канта за помощь в разработке этого раздела.</p>
					</div>
				</div>
				<div class="block_bottom">
	   			<div class="round_left">
...
<div class="right_block">
					...
					<div class="block_content" style="width:100%;">
						<div class="content">
							<script language="Javascript" src="//www.meteonova.ru/newsheaders/12.js"></script> 
						</div>
					</div>
					<div class="block_bottom">
