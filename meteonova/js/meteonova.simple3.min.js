...
/**
 �������� ����� opts.prop � �������� opts.elem
 �� opts.from �� opts.to ������������������ opts.duration
 � ����� opts.complete

 ��������: animateProp({ elem: ..., prop: 'height', start:0, end: 100, duration: 1000 })
*/
...
function _html5Audio(jessie) {
	...
	this._load = function(media_file) {
		this.mediaFile.file = media_file + this.mediaFile.ext;
	}
