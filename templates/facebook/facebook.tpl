...
<title>МЕТЕОНОВА: Facebook-бот Meteonovabot</title>
<!-- inject:css -->
<!-- endinject -->
<!-- inject:js -->
<!-- endinject -->
      ...
      <div class="main_container">
  		<div class="left_container">
			...
			<div class="block_content ie">
				...
				<div class="text">20 января, 2018</div>     				
     			</div>
     		</div>
			</div>
  		...
  		<div class="center_container">
			...
			<div class="block_content">
	 		 	<div class="content">
     				...
     				<a href="https://m.me/meteonovabot" target="_blank">Meteonovabot</a> - это удобный сервис получения прогноза погоды с помощью бесплатного кроссплатформенного мессенджера <a href="https://m.me" target="_blank">Facebook</a>
     				<br>Приложение показывает погоду сейчас и прогноз на 3 дня по любому из 50 тысяч городов мира из базы Метеоновы. Так же вы можете ознакомиться с самыми свежими погодными новостями
     				</div>
				</div>
				<div class="content">				
...
$(document).ready(function() {
	...
	function callback(event) {
		var discript = {
			"0": "После запуска вы можете сразу отправить боту запрос, введя название города в поле «Сообщение».  Можно ввести не все название города целиком, а первые несколько букв (не менее трех). В ответ вы получите список найденных городов в виде кнопок. Нажав на кнопку с нужным городом, Вы получите текущую погоду по нему. Также можно получить почасовой прогноз на ближайшие сутки или краткий прогноз погоды на три дня вперед.",
			...
			"4": "Вы также можете изменить единицы измерения, нажав кнопку «Настройка». Чтобы получать уведомления о погодных новостях, в настройках выберите кнопку Новости (Уведомления) и затем нажмите кнопку «Подписаться»",
